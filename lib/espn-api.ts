...
function parseESPNMatch(event: any): ESPNMatch {
  ...
  return {
    ...
    homeTeam: {
      ...
      name: homeCompetitor.team?.name || homeCompetitor.displayName || 'Unknown',
      displayName: homeCompetitor.displayName || homeCompetitor.team?.name || 'Unknown',
      abbreviation: homeCompetitor.team?.abbreviation,
      logo: homeCompetitor.team?.logo,
    },
    awayTeam: {
      id: awayCompetitor.team?.id || 'unknown',
      name: awayCompetitor.team?.name || awayCompetitor.displayName || 'Unknown',
      displayName: awayCompetitor.displayName || awayCompetitor.team?.name || 'Unknown',
