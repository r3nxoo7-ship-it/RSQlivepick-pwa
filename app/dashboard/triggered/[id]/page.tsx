        ...
        try {
          ...
          if (!fetchedStats && !isSofascoreMatch) {
            const leagueMap: Record<string, string> = {
              ...
              'Bundesliga': 'ger.1', '2. Bundesliga': 'ger.2', 'Ligue 1': 'fra.1', 'MLS': 'usa.1',
              'Championship': 'eng.2', 'League One': 'eng.3', 'League Two': 'eng.4',
              'La Liga 2': 'esp.2', 'Serie B': 'ita.2', 'Ligue 2': 'fra.2',
              'Eredivisie': 'ned.1', 'Eerste Divisie': 'ned.2',
              'Primeira Liga': 'por.1', 'Scottish Premiership': 'sco.1',
              'Belgian Pro League': 'bel.1',
              'Super Lig': 'tur.1', 'Turkish Super Lig': 'tur.1', 'TFF 1. Lig': 'tur.2',
              'Swiss Super League': 'sui.1', 'Austrian Bundesliga': 'aut.1',
              'Danish Superliga': 'den.1', 'Allsvenskan': 'swe.1', 'Eliteserien': 'nor.1',
              'Greek Super League': 'gre.1', 'Russian Premier League': 'rus.1',
              ...
              'Brasileirao Serie A': 'bra.1', 'Brasileirao Serie B': 'bra.2',
              'Argentine Primera': 'arg.1', 'Colombian Primera A': 'col.1',
              'Turkish Cup': 'tur.cup',
